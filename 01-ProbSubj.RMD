...
**Teorema 10:** Seja $A_1 \supseteq A_2 \supseteq \ldots$ uma seq. decrescente de eventos tais que $\bigcap_{i=1}^{n} A_i = \varnothing$. Então $\displaystyle \lim_{n \uparrow \infty} P(A_n) = 0$.
