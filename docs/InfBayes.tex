...
\begin{verbatim}
## 
## Laplace's Demon was called on Mon Jun 21 18:27:15 2021
## 
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-68-2} \end{center}
...
\begin{verbatim}
## 
## Laplace's Demon was called on Mon Jun 21 18:27:35 2021
## 
## Performing initial checks...
...
##      Covar=Fit2$Covar, Iterations=420000, Status=38709, Thinning=105,
...
\begin{verbatim}
## 
## Laplace's Demon was called on Mon Jun 21 18:28:00 2021
## 
## Performing initial checks...
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-71-2} \end{center}
...
## Chain 1:                3.142 seconds (Sampling)
## Chain 1:                3.439 seconds (Total)
## Chain 1: 
## 
...
## Chain 2:                4.023 seconds (Sampling)
## Chain 2:                4.304 seconds (Total)
## Chain 2:
\end{verbatim}
...
## 
## Samples were drawn using NUTS(diag_e) at Mon Jun 21 18:31:19 2021.
...
## Chain 1: 
## Chain 1:  Elapsed Time: 7.597 seconds (Warm-up)
## Chain 1:                7.607 seconds (Sampling)
## Chain 1:                15.204 seconds (Total)
## Chain 1: 
## 
...
## Chain 2: 
## Chain 2:  Elapsed Time: 8.994 seconds (Warm-up)
## Chain 2:                9.315 seconds (Sampling)
## Chain 2:                18.309 seconds (Total)
## Chain 2:
\end{verbatim}
...
## Chain 1: Iteration: 2000 / 2000 [100%]  (Sampling)
## Chain 1: 
## Chain 1:  Elapsed Time: 9.708 seconds (Warm-up)
## Chain 1:                8.487 seconds (Sampling)
...
## Chain 2: Iteration: 2000 / 2000 [100%]  (Sampling)
## Chain 2: 
## Chain 2:  Elapsed Time: 9.145 seconds (Warm-up)
## Chain 2:                7.489 seconds (Sampling)
## Chain 2:                16.634 seconds (Total)
## Chain 2:
\end{verbatim}
...
\begin{Highlighting}[]
\FunctionTok{require}\NormalTok{(walker)}
\NormalTok{dados1 }\OtherTok{=} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"./data/covid19{-}Brasil.io{-}SPSP.csv"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(epidemiological\_week,date,order\_for\_place,}
\NormalTok{         last\_available\_confirmed,new\_confirmed,}
\NormalTok{         last\_available\_confirmed\_per\_100k\_inhabitants,}
\NormalTok{         last\_available\_deaths,new\_deaths,}
\NormalTok{         last\_available\_death\_rate,estimated\_population)}
\NormalTok{dados2 }\OtherTok{=} \FunctionTok{rbind}\NormalTok{(}\FunctionTok{read\_csv}\NormalTok{(}\StringTok{"./data/2020\_BR\_Region\_Mobility\_Report.csv"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{filter}\NormalTok{(sub\_region\_1}\SpecialCharTok{==}\StringTok{"State of São Paulo"}\NormalTok{,sub\_region\_2}\SpecialCharTok{==}\StringTok{"São Paulo"}\NormalTok{),}
   \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"./data/2021\_BR\_Region\_Mobility\_Report.csv"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
    \FunctionTok{filter}\NormalTok{(sub\_region\_1}\SpecialCharTok{==}\StringTok{"State of São Paulo"}\NormalTok{,sub\_region\_2}\SpecialCharTok{==}\StringTok{"São Paulo"}\NormalTok{))}\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(date, retail\_and\_recreation\_percent\_change\_from\_baseline,}
\NormalTok{               grocery\_and\_pharmacy\_percent\_change\_from\_baseline,}
\NormalTok{               parks\_percent\_change\_from\_baseline,}
\NormalTok{               transit\_stations\_percent\_change\_from\_baseline,}
\NormalTok{               workplaces\_percent\_change\_from\_baseline,}
\NormalTok{               residential\_percent\_change\_from\_baseline)}
\NormalTok{dados }\OtherTok{=} \FunctionTok{inner\_join}\NormalTok{(dados1,dados2,}\AttributeTok{by=}\StringTok{"date"}\NormalTok{)}
