...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{posterior <-}\StringTok{ }\KeywordTok{extract}\NormalTok{(stan_mod)}
...
## Chain 1:                2.186 seconds (Sampling)
...
## 
## Samples were drawn using NUTS(diag_e) at Mon Nov 09 18:06:24 2020.
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-80-2} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-80-3} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-80-4} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-80-5} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-80-6} \end{center}
