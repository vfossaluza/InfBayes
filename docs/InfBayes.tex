...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/HiperparPrior-1} \end{center}
...
\[f(\boldsymbol x| \boldsymbol \theta)= \binom{n}{x_1,x_2,\ldots,x_k}~\prod_{i=1}^{k-1}\theta_i^{x_i}~\underbrace{\left(1-\sum_{i=1}^{k-1}\theta_i\right)^{\displaystyle n-\sum_{i=1}^{k-1}x_i}}_{\displaystyle \theta_k^{~~x_k}}\]
...
\textbf{Exemplo.} No gráfico a seguir, a distribuição a priori é uma \(\text{Pareto}(2,1)\) e foi observada uma amostra de tamanho \(5\) com \(x_{(n)}=2\), de modo que a posteriori é \(\text{Pareto}(7,2)\).

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a}\OtherTok{=}\DecValTok{2}\NormalTok{;b}\OtherTok{=}\DecValTok{1}
\NormalTok{n}\OtherTok{=}\DecValTok{5}\NormalTok{; xn}\OtherTok{=}\DecValTok{2}
\NormalTok{t }\OtherTok{=} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{,}\AttributeTok{length.out=}\DecValTok{1000}\NormalTok{)}
\NormalTok{prior }\OtherTok{=}\NormalTok{ extraDistr}\SpecialCharTok{::}\FunctionTok{dpareto}\NormalTok{(t,a,b)}
\NormalTok{vero }\OtherTok{=}\NormalTok{ ((n}\DecValTok{{-}1}\NormalTok{)}\SpecialCharTok{*}\NormalTok{xn}\SpecialCharTok{\^{}}\NormalTok{(n}\DecValTok{{-}1}\NormalTok{)) }\SpecialCharTok{*} \FunctionTok{I}\NormalTok{(t}\SpecialCharTok{\textgreater{}=}\DecValTok{2}\NormalTok{)}\SpecialCharTok{/}\NormalTok{(t}\SpecialCharTok{\^{}}\NormalTok{n)}
\NormalTok{post }\OtherTok{=}\NormalTok{ extraDistr}\SpecialCharTok{::}\FunctionTok{dpareto}\NormalTok{(t,a}\SpecialCharTok{+}\NormalTok{n,}\FunctionTok{max}\NormalTok{(b,xn))}
\FunctionTok{tibble}\NormalTok{(}\AttributeTok{theta=}\FunctionTok{rep}\NormalTok{(t,}\DecValTok{3}\NormalTok{),}\AttributeTok{dens=}\FunctionTok{c}\NormalTok{(prior,vero,post),}
    \AttributeTok{Dist=}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}1.Priori Pareto(2,1)\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}2.Verossimilhança\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}3.Posteriori\textquotesingle{}}\NormalTok{),}\AttributeTok{each=}\FunctionTok{length}\NormalTok{(t))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{.) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{theta,}\AttributeTok{y=}\NormalTok{dens,}\AttributeTok{colour=}\NormalTok{Dist),}\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ParetoConjugatePrior-1} \end{center}
...
\begin{quote}
\textbf{Demo:}\\
\(f(\boldsymbol x, \boldsymbol y|\theta)\overset{ci}{=}f(\boldsymbol x|\theta)f(\boldsymbol y|\theta)\overset{ci}{=}\) \(\prod_{i=1}^nf(x_i|\theta)\prod_{j=1}^mf(y_i|\theta)=\) \(\prod_{i=1}^n\theta e^{-\theta x_i}\prod_{j=1}^m\dfrac{\theta^{y_j}e^{-\theta}}{y_j!}=\) \(\theta^{n}e^{-\theta\sum_i x_i}~ \dfrac{\theta^{\sum_j y_j}e^{-m\theta}}{\prod_{j=1}^my_j!}=\) \(\dfrac{1}{\prod_{j=1}^my_j!}\theta^{n+\sum_j y_j}e^{-(m+\sum_ix_i)\theta}\)\\
\(~\)\\
...
\textbf{Exemplo.} Considere que a distribuição a priori é uma \(\text{Gama}(2,2)\) e foi observado \(n=4\), \(\sum x=1\), \(m=5\) e \(\sum y=10\), de modo que a posteriori é \(\text{Gama}(16,9)\).

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{a}\OtherTok{=}\DecValTok{2}\NormalTok{;b}\OtherTok{=}\DecValTok{2}
\NormalTok{n}\OtherTok{=}\DecValTok{4}\NormalTok{; sumx}\OtherTok{=}\DecValTok{1}
\NormalTok{m}\OtherTok{=}\DecValTok{6}\NormalTok{; sumy}\OtherTok{=}\DecValTok{10}
\NormalTok{t }\OtherTok{=} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{,}\AttributeTok{length.out=}\DecValTok{1000}\NormalTok{)}
\NormalTok{prior }\OtherTok{=} \FunctionTok{dgamma}\NormalTok{(t,a,b)}
\NormalTok{vero }\OtherTok{=} \FunctionTok{dgamma}\NormalTok{(t,n}\SpecialCharTok{+}\NormalTok{sumy}\SpecialCharTok{+}\DecValTok{1}\NormalTok{,m}\SpecialCharTok{+}\NormalTok{sumx)}
\NormalTok{post }\OtherTok{=} \FunctionTok{dgamma}\NormalTok{(t,a}\SpecialCharTok{+}\NormalTok{n}\SpecialCharTok{+}\NormalTok{sumy,b}\SpecialCharTok{+}\NormalTok{m}\SpecialCharTok{+}\NormalTok{sumx)}
\FunctionTok{tibble}\NormalTok{(}\AttributeTok{theta=}\FunctionTok{rep}\NormalTok{(t,}\DecValTok{3}\NormalTok{),}\AttributeTok{dens=}\FunctionTok{c}\NormalTok{(prior,vero,post),}
    \AttributeTok{Dist=}\FunctionTok{rep}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}1.Priori Gama(2,2)\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}2.Verossimilhança\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}3.Posteriori\textquotesingle{}}\NormalTok{),}\AttributeTok{each=}\FunctionTok{length}\NormalTok{(t))) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\AttributeTok{data=}\NormalTok{.) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{theta,}\AttributeTok{y=}\NormalTok{dens,}\AttributeTok{colour=}\NormalTok{Dist),}\AttributeTok{lwd=}\FloatTok{1.2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/GammaConjugatePrior-1} \end{center}
...
\textbf{Exemplo 1.} Seja \(X|\theta \sim Bin(n,\theta)\) e \(f(\theta)\) \(=wf_1(\theta)+(1-w)f_2(\theta)\), com \(f_1\sim Beta(a_1,b_1)\) e \(f_2\sim Beta(a_2,b_2)\).
...
\textbf{Exemplo 2.} Suponha que \(\theta\) é uma proporção e você deseja construir uma distribuição a priori baseada em estudos anteriores. Como, em geral, os dados de outros estudos não estão disponíveis na íntegra, você pode utilizar estatísticas resumo.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{estudos }\OtherTok{=} \FunctionTok{tibble}\NormalTok{(}\AttributeTok{Paper=}\FunctionTok{c}\NormalTok{(}\StringTok{"Estudo 1"}\NormalTok{, }\StringTok{"Estudo 2"}\NormalTok{, }\StringTok{"Estudo 3"}\NormalTok{),}
                 \AttributeTok{n=}\FunctionTok{c}\NormalTok{(}\DecValTok{78}\NormalTok{,}\DecValTok{60}\NormalTok{,}\DecValTok{40}\NormalTok{),}\AttributeTok{Cases=}\FunctionTok{c}\NormalTok{(}\DecValTok{30}\NormalTok{,}\DecValTok{42}\NormalTok{,}\DecValTok{30}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
            \FunctionTok{mutate}\NormalTok{(}\AttributeTok{p=}\NormalTok{Cases}\SpecialCharTok{/}\NormalTok{n) }\SpecialCharTok{\%\textgreater{}\%} 
            \FunctionTok{mutate}\NormalTok{(}\AttributeTok{inf=}\FunctionTok{round}\NormalTok{(p}\SpecialCharTok{{-}}\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(p}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{p)}\SpecialCharTok{/}\NormalTok{n),}\DecValTok{3}\NormalTok{),}
                   \AttributeTok{sup=}\FunctionTok{round}\NormalTok{(p}\SpecialCharTok{+}\FunctionTok{qnorm}\NormalTok{(}\FloatTok{0.975}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(p}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{{-}}\NormalTok{p)}\SpecialCharTok{/}\NormalTok{n),}\DecValTok{3}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
            \FunctionTok{mutate}\NormalTok{(}\AttributeTok{inf=}\FunctionTok{ifelse}\NormalTok{(inf}\SpecialCharTok{\textless{}}\DecValTok{0}\NormalTok{,}\FloatTok{0.000}\NormalTok{,inf),}
                   \AttributeTok{sup=}\FunctionTok{ifelse}\NormalTok{(sup}\SpecialCharTok{\textgreater{}}\DecValTok{1}\NormalTok{,}\FloatTok{1.000}\NormalTok{,sup)) }\SpecialCharTok{\%\textgreater{}\%} 
            \FunctionTok{mutate}\NormalTok{(}\AttributeTok{CI=}\FunctionTok{paste}\NormalTok{(}\StringTok{"["}\NormalTok{,inf,}\StringTok{" ; "}\NormalTok{,sup,}\StringTok{" ]"}\NormalTok{))}

\FunctionTok{rbind}\NormalTok{(estudos) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{select}\NormalTok{(Paper,n,Cases,p,CI) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{  kableExtra}\SpecialCharTok{::}\FunctionTok{kbl}\NormalTok{(.,}\AttributeTok{digits=}\DecValTok{3}\NormalTok{,}\AttributeTok{align=}\FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}l\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}c\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}c\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}c\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}c\textquotesingle{}}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
...
\textbf{Proposta 1.} Uma primeira forma de fazer isso seria supor que, antes de observar esses estudos, você não tem informação sobre \(\theta\), e usar a posteriori obtida com os dados do estudos como priori. Assim, seja \(X_i|\theta \sim \text{Bin}(n_i,\theta)\), \(i=1,2,3\), e \(\theta \sim \text{Uniforme}(0,1)\). Temos que
\[\theta | x_1 \sim \text{Beta}(1+x_1,1+n_1-x_1)\]
\[\theta | x_1,x_2 \sim \text{Beta}(1+x_1+x_2,1+n_1-x_1+n_2-x_2)\]
\[\theta | x_1,x_2,x_3 \sim \text{Beta}(1+x_1+x_2+x_3,1+n_1-x_1+n_2-x_2+n3-x_3)\]

Isso é equivalente a juntar todos os estudos e calcular diretamente a posteriori. Seja \(x=x_1+x_2+x_3\) e \(n=n_1+n_2+n_3\). Então,
\[\theta \sim \text{Beta}(1,1) \implies \theta | x_1,x_2,x_3 \sim \text{Beta}(1+x,1+n-x)~.\]
\(~\)
...
\(f(\theta|x,y)\) \(\propto f(y|\theta)~f(\theta|x)\)
\(\propto f(y|\theta)f(x|\theta)f(\theta)\)
\(\propto f(x,y|\theta)f(\theta)~.\)

\(~\)

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{eixox}\OtherTok{=}\FunctionTok{c}\NormalTok{(}\FunctionTok{min}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{inf),}\FunctionTok{max}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{sup))}

\NormalTok{PriorsPlot}\OtherTok{=}\FunctionTok{tibble}\NormalTok{(}\AttributeTok{theta=}\FunctionTok{seq}\NormalTok{(eixox[}\DecValTok{1}\NormalTok{],eixox[}\DecValTok{2}\NormalTok{],}\AttributeTok{length.out=}\DecValTok{1000}\NormalTok{),}
              \AttributeTok{beta=}\FunctionTok{dbeta}\NormalTok{(theta,}\FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{Cases)}\SpecialCharTok{+}\DecValTok{1}\NormalTok{,}
                            \FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{n)}\SpecialCharTok{{-}}\FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{Cases)}\SpecialCharTok{+}\DecValTok{1}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{theta,}\AttributeTok{y=}\NormalTok{beta, }\AttributeTok{colour=}\StringTok{"Beta"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{colour=}\StringTok{"Priori"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{xlim}\NormalTok{(eixox) }\SpecialCharTok{+} 
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"theta"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"Prior"}\NormalTok{)}

\NormalTok{Meta}\OtherTok{=}\NormalTok{estudos }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y=}\NormalTok{Paper))}\SpecialCharTok{+}\FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{p))}\SpecialCharTok{+}
  \FunctionTok{geom\_segment}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{inf,}\AttributeTok{xend=}\NormalTok{sup,}\AttributeTok{y=}\NormalTok{Paper,}\AttributeTok{yend=}\NormalTok{Paper))}\SpecialCharTok{+}
  ...
  \FunctionTok{xlim}\NormalTok{(eixox)}\SpecialCharTok{+}\FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept=}\FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{Cases)}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{n), }\AttributeTok{color=}\StringTok{\textquotesingle{}darkgrey\textquotesingle{}}\NormalTok{, }\AttributeTok{linetype=}\StringTok{\textquotesingle{}dashed\textquotesingle{}}\NormalTok{)}

\NormalTok{ggpubr}\SpecialCharTok{::}\FunctionTok{ggarrange}\NormalTok{(PriorsPlot,Meta,}\AttributeTok{heights=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{),}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ExMeta_Beta-1} \end{center}

\textbf{Proposta 2} Considere agora que a priori será construída da seguinte forma: para cada estudo será calculada uma ``posteriori'' supondo que \(\theta \sim \text{Uniforme}(0,1)\) e faremos uma mistura dessas posterioris ponderada pelo tamanho amostral dos estudos. Assim:

\[f(\theta) = \sum_{i=1}^{3} \frac{n_i}{n}~f(\theta~|~a_i=1+x_i~,~b_i=1+n_i-x_i)~,\]
em que \(f(\theta~|~a~,~b)\) é a densidade da \(\text{Beta}(a,b)\) e \(n=n_1+n_2+n_3\). No exemplo,
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dmixbeta}\OtherTok{=}\ControlFlowTok{function}\NormalTok{(theta,w,a,b)\{}
\NormalTok{  w }\OtherTok{=}\NormalTok{ w}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(w)}
  \FunctionTok{apply}\NormalTok{(}\FunctionTok{as.matrix}\NormalTok{(theta),}\DecValTok{1}\NormalTok{,}\ControlFlowTok{function}\NormalTok{(t)\{}\FunctionTok{t}\NormalTok{(w)}\SpecialCharTok{\%*\%}\FunctionTok{dbeta}\NormalTok{(t,a,b)\})}
\NormalTok{\}}
\NormalTok{pmixbeta}\OtherTok{=}\ControlFlowTok{function}\NormalTok{(theta,w,a,b)\{}
\NormalTok{  w }\OtherTok{=}\NormalTok{ w}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(w)}
  \FunctionTok{apply}\NormalTok{(}\FunctionTok{as.matrix}\NormalTok{(theta),}\DecValTok{1}\NormalTok{,}\ControlFlowTok{function}\NormalTok{(t)\{}\FunctionTok{t}\NormalTok{(w)}\SpecialCharTok{\%*\%}\FunctionTok{pbeta}\NormalTok{(t,a,b)\})}
\NormalTok{\}}
\NormalTok{rmixbeta}\OtherTok{=}\ControlFlowTok{function}\NormalTok{(n,w,a,b)\{}
\NormalTok{  w }\OtherTok{=}\NormalTok{ w}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(w)}
\NormalTok{  s }\OtherTok{=} \FunctionTok{rmultinom}\NormalTok{(}\AttributeTok{n=}\NormalTok{n,}\AttributeTok{size=}\DecValTok{1}\NormalTok{,}\AttributeTok{prob=}\NormalTok{w)}
  \FunctionTok{apply}\NormalTok{(}\FunctionTok{t}\NormalTok{(s),}\DecValTok{1}\NormalTok{,}\ControlFlowTok{function}\NormalTok{(l)\{}\FunctionTok{rbeta}\NormalTok{(}\DecValTok{1}\NormalTok{,l}\SpecialCharTok{\%*\%}\NormalTok{a,l}\SpecialCharTok{\%*\%}\NormalTok{b)\})}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{eixox}\OtherTok{=}\FunctionTok{c}\NormalTok{(}\FunctionTok{min}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{inf),}\FunctionTok{max}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{sup))}
\CommentTok{\#Parametros da Priori}
\NormalTok{w}\OtherTok{=}\NormalTok{estudos}\SpecialCharTok{$}\NormalTok{n}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{n)}
\NormalTok{a}\OtherTok{=}\NormalTok{estudos}\SpecialCharTok{$}\NormalTok{Cases}\SpecialCharTok{+}\DecValTok{1}
\NormalTok{b}\OtherTok{=}\NormalTok{estudos}\SpecialCharTok{$}\NormalTok{n}\SpecialCharTok{{-}}\NormalTok{estudos}\SpecialCharTok{$}\NormalTok{Cases}\SpecialCharTok{+}\DecValTok{1}

\NormalTok{PriorsPlot}\OtherTok{=}\FunctionTok{tibble}\NormalTok{(}\AttributeTok{theta=}\FunctionTok{seq}\NormalTok{(eixox[}\DecValTok{1}\NormalTok{],eixox[}\DecValTok{2}\NormalTok{],}\AttributeTok{length.out=}\DecValTok{1000}\NormalTok{),}
              \AttributeTok{beta=}\FunctionTok{dbeta}\NormalTok{(theta,}\FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{Cases)}\SpecialCharTok{+}\DecValTok{1}\NormalTok{,}
                            \FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{n)}\SpecialCharTok{{-}}\FunctionTok{sum}\NormalTok{(estudos}\SpecialCharTok{$}\NormalTok{Cases)}\SpecialCharTok{+}\DecValTok{1}\NormalTok{),}
              \AttributeTok{meta=}\FunctionTok{dmixbeta}\NormalTok{(theta,w,a,b)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{theta,}\AttributeTok{y=}\NormalTok{beta, }\AttributeTok{colour=}\StringTok{"Beta"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{theta,}\AttributeTok{y=}\NormalTok{meta, }\AttributeTok{colour=}\StringTok{"Metanalítica"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{colour=}\StringTok{"Priori"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{xlim}\NormalTok{(eixox) }\SpecialCharTok{+} 
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"theta"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"Prior"}\NormalTok{)}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ExMeta_Meta-1} \end{center}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{n}\OtherTok{=}\DecValTok{100}\NormalTok{; x}\OtherTok{=}\DecValTok{67}
\CommentTok{\# Parametros da posteriori}
\NormalTok{wx }\OtherTok{=} \FunctionTok{exp}\NormalTok{( }\FunctionTok{log}\NormalTok{(w)}\SpecialCharTok{+}\FunctionTok{lgamma}\NormalTok{(a}\SpecialCharTok{+}\NormalTok{b)}\SpecialCharTok{+}\FunctionTok{lgamma}\NormalTok{(a}\SpecialCharTok{+}\NormalTok{x)}\SpecialCharTok{+}\FunctionTok{lgamma}\NormalTok{(b}\SpecialCharTok{+}\NormalTok{n}\SpecialCharTok{{-}}\NormalTok{x)}\SpecialCharTok{{-}}
             \FunctionTok{lgamma}\NormalTok{(a}\SpecialCharTok{+}\NormalTok{b}\SpecialCharTok{+}\NormalTok{n)}\SpecialCharTok{{-}}\FunctionTok{lgamma}\NormalTok{(a)}\SpecialCharTok{{-}}\FunctionTok{lgamma}\NormalTok{(b) )}
\NormalTok{wx }\OtherTok{=}\NormalTok{ wx}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(wx)}
\NormalTok{ax}\OtherTok{=}\NormalTok{a}\SpecialCharTok{+}\NormalTok{x}
\NormalTok{bx}\OtherTok{=}\NormalTok{b}\SpecialCharTok{+}\NormalTok{n}\SpecialCharTok{{-}}\NormalTok{x}

\FunctionTok{tibble}\NormalTok{(}\AttributeTok{theta=}\FunctionTok{seq}\NormalTok{(eixox[}\DecValTok{1}\NormalTok{],eixox[}\DecValTok{2}\NormalTok{],}\AttributeTok{length.out=}\DecValTok{1000}\NormalTok{),}
       \AttributeTok{meta=}\FunctionTok{dmixbeta}\NormalTok{(theta,w,a,b), }\AttributeTok{post=}\FunctionTok{dmixbeta}\NormalTok{(theta,wx,ax,bx)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{theta,}\AttributeTok{y=}\NormalTok{meta, }\AttributeTok{colour=}\StringTok{"Priori"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{theta,}\AttributeTok{y=}\NormalTok{post, }\AttributeTok{colour=}\StringTok{"Posteriori"}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{colour=}\StringTok{"Distribuição"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{xlim}\NormalTok{(eixox) }\SpecialCharTok{+} 
  \FunctionTok{xlab}\NormalTok{(}\StringTok{"theta"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylab}\NormalTok{(}\StringTok{"densidade"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ExMeta_Posteriori-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-41-1} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-43-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-45-1} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-47-1} \end{center}
...
\midrule
\endhead
\vtop{\hbox{\strut sigma2}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 1.2 (0.5)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut 0.3 \textless{} 1.1 \textless{} 7.3}\hbox{\strut IQR (CV) : 0.6 (0.4)}} & 10000 distinct values & \includegraphics{./tmp/ds0035.png} \\
\vtop{\hbox{\strut mu}\hbox{\strut {[}numeric{]}}} & \vtop{\hbox{\strut Mean (sd) : 0 (1.5)}\hbox{\strut min \textless{} med \textless{} max:}\hbox{\strut -7.3 \textless{} 0 \textless{} 6.1}\hbox{\strut IQR (CV) : 2 (-253.7)}} & 10000 distinct values & \includegraphics{./tmp/ds0036.png} \\
\bottomrule
\end{longtable}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-50-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-52-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/unnamed-chunk-58-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/boringreg-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/reglin_margpost-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/reglin_postbi-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/reglin_HPDbi-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_MWG-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_MWG-2} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_AMWG-1} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_AMWG-2} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_Compar1-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_AFSS-1} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_AFSS-2} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_Compar2-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{p.interval}\NormalTok{(Post3}\SpecialCharTok{$}\NormalTok{beta2, }\AttributeTok{HPD=}\ConstantTok{TRUE}\NormalTok{, }\AttributeTok{MM=}\ConstantTok{FALSE}\NormalTok{, }\AttributeTok{plot=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_HPDbeta2-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/LaplacesDemon_ComparBi-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/rstan_LM_Compar1-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/rstan_LM_Compar2-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ggmcmc_hist-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ggmcmc_dens-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ggmcmc_trace-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ggmcmc_run-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ggmcmc_part-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ggmcmc_autocor-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ggmcmc_crosscor-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/ggmcmc_pairs-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/stan_logreg-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/stan_logreg-2} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/stan_logreg-3} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/stan_logreg-4} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/stan_logreg-5} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/stan_logreg_mc-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# H: beta\_2==0}
\NormalTok{lpostlog\_H }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(beta1)\{}\FunctionTok{lpostlog}\NormalTok{(beta1,}\DecValTok{0}\NormalTok{)\}}
\NormalTok{suplog\_H }\OtherTok{=} \FunctionTok{optimize}\NormalTok{(}\AttributeTok{f=}\NormalTok{lpostlog\_H,}\AttributeTok{interval=}\FunctionTok{c}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{100}\NormalTok{,}\DecValTok{100}\NormalTok{),}\AttributeTok{maximum=}\ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{$}\NormalTok{objective}
\NormalTok{ev\_logH }\OtherTok{=} \FunctionTok{mean}\NormalTok{(}\FunctionTok{I}\NormalTok{(lpostlog\_stan}\SpecialCharTok{\textless{}}\NormalTok{suplog\_H))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{dados }\OtherTok{=} \FunctionTok{read\_csv}\NormalTok{(}\StringTok{"./data/Amoxicillin.csv"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_fit-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_coefs-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_pred1-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{666}\NormalTok{)}
\NormalTok{new\_data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{Vendas=}\FunctionTok{seq}\NormalTok{(dados}\SpecialCharTok{$}\NormalTok{Vendas[}\DecValTok{108}\NormalTok{]}\SpecialCharTok{{-}}\NormalTok{mAntes[}\DecValTok{1}\NormalTok{],}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{,}\AttributeTok{length.out=}\DecValTok{12}\NormalTok{)}\SpecialCharTok{+}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{11}\NormalTok{,}\DecValTok{0}\NormalTok{,}\FloatTok{0.08}\NormalTok{)))}
\NormalTok{pred1 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fit1, new\_data)}
\FunctionTok{plot\_predict}\NormalTok{(pred1, }\AttributeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}\AttributeTok{breaks=}\FunctionTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\FunctionTok{length}\NormalTok{(dados}\SpecialCharTok{$}\NormalTok{Período)}\SpecialCharTok{+}\DecValTok{1}\NormalTok{,}\DecValTok{12}\NormalTok{),}\AttributeTok{labels=}\FunctionTok{c}\NormalTok{(}\FunctionTok{unique}\NormalTok{(}\FunctionTok{year}\NormalTok{(dados}\SpecialCharTok{$}\NormalTok{Período)),}\DecValTok{2017}\NormalTok{))}
\end{Highlighting}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_pred2-1} \end{center}
...
\NormalTok{ggpubr}\SpecialCharTok{::}\FunctionTok{ggarrange}\NormalTok{(}
  ...
  \FunctionTok{mcmc\_areas}\NormalTok{(}\FunctionTok{as.matrix}\NormalTok{(fit2}\SpecialCharTok{$}\NormalTok{stanfit), }\AttributeTok{regex\_pars =} \FunctionTok{c}\NormalTok{(}\StringTok{"sigma\_y"}\NormalTok{), }\AttributeTok{prob=}\FloatTok{0.9}\NormalTok{),}\AttributeTok{ncol=}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_rw2-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_coefs2-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_check2-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_pred21-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/walker_amox_pred22-1} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/dados_covid-1} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/dados_covid-2} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/dados_covid-3} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/dados_covid-4} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/dados_covid-5} \end{center}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/dados_covid-6} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ds }\OtherTok{=}\NormalTok{  dados }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{y=}\NormalTok{new\_confirmed,}\AttributeTok{x1=}\NormalTok{retail\_and\_recreation\_percent\_change\_from\_baseline,}\AttributeTok{x2=}\NormalTok{grocery\_and\_pharmacy\_percent\_change\_from\_baseline,}\AttributeTok{x3=}\NormalTok{parks\_percent\_change\_from\_baseline,}\AttributeTok{x4=}\NormalTok{dados}\SpecialCharTok{$}\NormalTok{transit\_stations\_percent\_change\_from\_baseline,}\AttributeTok{x5=}\NormalTok{workplaces\_percent\_change\_from\_baseline, }\AttributeTok{x6=}\NormalTok{residential\_percent\_change\_from\_baseline, }\AttributeTok{t=}\NormalTok{date, }\AttributeTok{y2=}\NormalTok{new\_deaths) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{arrange}\NormalTok{(date) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{select}\NormalTok{(t,y,x1,x2,x3,x4,x5,x6,y2) }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{filter}\NormalTok{(t}\SpecialCharTok{\textgreater{}=}\StringTok{"2020{-}03{-}23"}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \CommentTok{\# uma semana após início da quarentena}
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{x=}\NormalTok{x6}\SpecialCharTok{{-}}\NormalTok{x4)             }\CommentTok{\# "Índice de Mobilidade" (inventei!)}
  
\NormalTok{seriesxy}\OtherTok{=}\NormalTok{ds }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(t,y,x) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{series}\NormalTok{(.,}\AttributeTok{name1=}\StringTok{"Casos Novos"}\NormalTok{,}\AttributeTok{name2=}\StringTok{"Índice de Mobilidade"}\NormalTok{)}
\NormalTok{seriesxy}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/plotseriesxy-1} \end{center}
...
\NormalTok{labelx }\OtherTok{=}\NormalTok{ ds }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(t) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{x=}\FunctionTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\FunctionTok{nrow}\NormalTok{(ds)),}\AttributeTok{dia1=}\NormalTok{lubridate}\SpecialCharTok{::}\FunctionTok{day}\NormalTok{(t),}
         \AttributeTok{labx=}\NormalTok{lubridate}\SpecialCharTok{::}\FunctionTok{month}\NormalTok{(t, }\AttributeTok{label =} \ConstantTok{TRUE}\NormalTok{)) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{filter}\NormalTok{(dia1}\SpecialCharTok{==}\DecValTok{1}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{select}\NormalTok{(x,labx) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{add\_row}\NormalTok{(}\AttributeTok{x=}\DecValTok{214}\NormalTok{,}\AttributeTok{labx=}\StringTok{"nov"}\NormalTok{,}\AttributeTok{.after=}\DecValTok{7}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{add\_row}\NormalTok{(}\AttributeTok{x=}\DecValTok{267}\NormalTok{,}\AttributeTok{labx=}\StringTok{"jan"}\NormalTok{,}\AttributeTok{.after=}\DecValTok{9}\NormalTok{) }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{add\_row}\NormalTok{(}\AttributeTok{x=}\FunctionTok{c}\NormalTok{(}\DecValTok{385}\NormalTok{,}\DecValTok{414}\NormalTok{),}\AttributeTok{labx=}\FunctionTok{c}\NormalTok{(}\StringTok{"mai"}\NormalTok{,}\StringTok{"jun"}\NormalTok{))}

\NormalTok{ggpubr}\SpecialCharTok{::}\FunctionTok{ggarrange}\NormalTok{(}
  \FunctionTok{mcmc\_areas}\NormalTok{(fit1}\SpecialCharTok{$}\NormalTok{stanfit,}\AttributeTok{pars =} \FunctionTok{c}\NormalTok{(}\StringTok{"sigma\_rw1[1]"}\NormalTok{),}\AttributeTok{prob=}\FloatTok{0.9}\NormalTok{),}
  \FunctionTok{mcmc\_areas}\NormalTok{(fit1}\SpecialCharTok{$}\NormalTok{stanfit,}\AttributeTok{pars =} \FunctionTok{c}\NormalTok{(}\StringTok{"sigma\_rw1[2]"}\NormalTok{),}\AttributeTok{prob=}\FloatTok{0.9}\NormalTok{),}
  \FunctionTok{mcmc\_areas}\NormalTok{(fit1}\SpecialCharTok{$}\NormalTok{stanfit,}\AttributeTok{pars =} \FunctionTok{c}\NormalTok{(}\StringTok{"sigma\_y"}\NormalTok{),}\AttributeTok{prob=}\FloatTok{0.9}\NormalTok{),}
  \AttributeTok{ncol=}\DecValTok{1}\NormalTok{,}\AttributeTok{align=}\StringTok{"v"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/covid1-1} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{plotcoef}\OtherTok{=}\FunctionTok{plot\_coefs2}\NormalTok{(fit1,}\AttributeTok{scales=}\StringTok{"free"}\NormalTok{,}\AttributeTok{alpha=}\FloatTok{0.8}\NormalTok{,}\AttributeTok{col=}\DecValTok{1}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{theme\_bw}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}\AttributeTok{breaks=}\NormalTok{labelx}\SpecialCharTok{$}\NormalTok{x,}\AttributeTok{labels=}\NormalTok{labelx}\SpecialCharTok{$}\NormalTok{labx)}
\NormalTok{plotcoef}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/covid1-2} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/covid1-3} \end{center}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/covid1-4} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# predição com aumento da taxa de isolamento}
\NormalTok{new\_data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x=}\FunctionTok{seq}\NormalTok{(}\DecValTok{34}\NormalTok{,}\DecValTok{64}\NormalTok{,}\AttributeTok{length.out=}\DecValTok{30}\NormalTok{))}
\NormalTok{pred1 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fit1, new\_data)}
\FunctionTok{plot\_predict}\NormalTok{(pred1, }\AttributeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}\AttributeTok{breaks=}\NormalTok{labelx}\SpecialCharTok{$}\NormalTok{x,}\AttributeTok{labels=}\NormalTok{labelx}\SpecialCharTok{$}\NormalTok{labx)}
\end{Highlighting}
...
\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/covid1-5} \end{center}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#predição com diminuição da taxa de isolamento}
\NormalTok{new\_data }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x=}\FunctionTok{seq}\NormalTok{(}\DecValTok{34}\NormalTok{,}\DecValTok{4}\NormalTok{,}\AttributeTok{length.out=}\DecValTok{30}\NormalTok{))}
\NormalTok{pred2 }\OtherTok{\textless{}{-}} \FunctionTok{predict}\NormalTok{(fit1, new\_data)}
\FunctionTok{plot\_predict}\NormalTok{(pred2, }\AttributeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}\AttributeTok{breaks=}\NormalTok{labelx}\SpecialCharTok{$}\NormalTok{x,}\AttributeTok{labels=}\NormalTok{labelx}\SpecialCharTok{$}\NormalTok{labx)}
\end{Highlighting}
\end{Shaded}

\begin{center}\includegraphics[width=0.8\linewidth]{InfBayes_files/figure-latex/covid1-6} \end{center}
