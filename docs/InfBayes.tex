...
\NormalTok{dados =}\StringTok{ }\KeywordTok{read_csv}\NormalTok{(}\StringTok{"Amoxicillin.csv"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(Perí}\DataTypeTok{odo=}\NormalTok{Periodo,}\DataTypeTok{Vendas=}\NormalTok{DDD1000hab_dia,Resistência=Resistencia_Amoxicilina.Clavulanato.k)}
\NormalTok{dados}\OperatorTok{$}\NormalTok{Vendas[}\DecValTok{61}\OperatorTok{:}\DecValTok{62}\NormalTok{]=}\KeywordTok{mean}\NormalTok{(}\KeywordTok{c}\NormalTok{(}\FloatTok{2.073005}\NormalTok{,}\FloatTok{2.173923}\NormalTok{))}
\NormalTok{mV=}\KeywordTok{mean}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Vendas); sdV=}\KeywordTok{sd}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Vendas)}
\NormalTok{mR=}\KeywordTok{mean}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Resistência); }\DataTypeTok{sdR=}\KeywordTok{sd}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Resistência)}
\NormalTok{Tr <-}\StringTok{ }\NormalTok{sdV}\OperatorTok{/}\NormalTok{sdR }\CommentTok{# var. aux. para transformação dos eixos}
\NormalTok{dados }\OperatorTok{%>%}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Período)) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y=}\NormalTok{Vendas,}\DataTypeTok{colour=}\StringTok{"Vendas"}\NormalTok{),}\DataTypeTok{lwd=}\DecValTok{1}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position=}\StringTok{"bottom"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Período,}\DataTypeTok{y=}\NormalTok{((Resistência-mR)}\OperatorTok{*}\NormalTok{Tr}\OperatorTok{+}\NormalTok{mV),}\DataTypeTok{colour=}\StringTok{"Resistência"),lwd=1)+}
\StringTok{  labs(y="}\NormalTok{Vendas de }\KeywordTok{Amoxicilina}\NormalTok{ (DDD}\OperatorTok{/}\DecValTok{1000}\NormalTok{ hab.}\OperatorTok{/}\NormalTok{dia)}\StringTok{",colour="") + }
\StringTok{  scale_y_continuous(sec.axis = sec_axis(~./Tr+(mR-mV/Tr), name = "}\NormalTok{Prop. de Amostras de E.Colli Resistentes}\StringTok{"))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(walker)}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{666}\NormalTok{)}
\CommentTok{# resistência média e venda média do período anterior a RDC 44}
\NormalTok{mAntes =}\StringTok{ }\NormalTok{dados }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(}\KeywordTok{year}\NormalTok{(Período)}\OperatorTok{<}\DecValTok{2011}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{        }\KeywordTok{summarise}\NormalTok{(}\KeywordTok{mean}\NormalTok{(Vendas),}\KeywordTok{mean}\NormalTok{(Resistência)) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{t}\NormalTok{()}
\NormalTok{fit1 <-}\StringTok{ }\NormalTok{dados }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Vendas=}\NormalTok{Vendas}\OperatorTok{-}\NormalTok{mAntes[}\DecValTok{1}\NormalTok{],Resistência=Resistência-mAntes[}\DecValTok{2}\NormalTok{]) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{walker}\NormalTok{(}\DataTypeTok{data=}\NormalTok{., }\DataTypeTok{formula =}\NormalTok{ Resistência }\OperatorTok{~}\StringTok{ }\DecValTok{-1}\OperatorTok{+}\KeywordTok{rw1}\NormalTok{(}\OperatorTok{~}\StringTok{ }\DecValTok{-1}\OperatorTok{+}\NormalTok{Vendas,}\DataTypeTok{beta=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{),}
    \DataTypeTok{sigma=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{)),}\DataTypeTok{sigma_y_prior =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{), }\DataTypeTok{chain=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{multiplot}\NormalTok{(}
  \CommentTok{#mcmc_areas(as.matrix(fit1$stanfit), regex_pars = c("beta_fixed"), prob=0.9),}
  \KeywordTok{mcmc_areas}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(fit1}\OperatorTok{$}\NormalTok{stanfit), }\DataTypeTok{regex_pars =} \KeywordTok{c}\NormalTok{(}\StringTok{"sigma_rw1"}\NormalTok{), }\DataTypeTok{prob=}\FloatTok{0.9}\NormalTok{),}
  \KeywordTok{mcmc_areas}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(fit1}\OperatorTok{$}\NormalTok{stanfit), }\DataTypeTok{regex_pars =} \KeywordTok{c}\NormalTok{(}\StringTok{"sigma_y"}\NormalTok{), }\DataTypeTok{prob=}\FloatTok{0.9}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_coefs}\NormalTok{(fit1, }\DataTypeTok{scales =} \StringTok{"free"}\NormalTok{, }\DataTypeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\KeywordTok{length}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)}\OperatorTok{+}\DecValTok{1}\NormalTok{,}\DecValTok{12}\NormalTok{),}\DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\KeywordTok{unique}\NormalTok{(}\KeywordTok{year}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)),}\DecValTok{2017}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pp_check}\NormalTok{(fit1, }\DataTypeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\KeywordTok{length}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)}\OperatorTok{+}\DecValTok{1}\NormalTok{,}\DecValTok{12}\NormalTok{),}\DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\KeywordTok{unique}\NormalTok{(}\KeywordTok{year}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)),}\DecValTok{2017}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{new_data <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Vendas=}\KeywordTok{seq}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Vendas[}\DecValTok{108}\NormalTok{]}\OperatorTok{-}\NormalTok{mAntes[}\DecValTok{1}\NormalTok{],}\OperatorTok{-}\FloatTok{0.4}\NormalTok{,}\DataTypeTok{length.out=}\DecValTok{12}\NormalTok{)}\OperatorTok{+}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\KeywordTok{rnorm}\NormalTok{(}\DecValTok{11}\NormalTok{,}\DecValTok{0}\NormalTok{,}\FloatTok{0.08}\NormalTok{)))}
\NormalTok{pred1 <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit1, new_data)}
\KeywordTok{plot_predict}\NormalTok{(pred1, }\DataTypeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\KeywordTok{length}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)}\OperatorTok{+}\DecValTok{1}\NormalTok{,}\DecValTok{12}\NormalTok{),}\DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\KeywordTok{unique}\NormalTok{(}\KeywordTok{year}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)),}\DecValTok{2017}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{new_data <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Vendas=}\KeywordTok{seq}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Vendas[}\DecValTok{108}\NormalTok{]}\OperatorTok{-}\NormalTok{mAntes[}\DecValTok{1}\NormalTok{],}\OperatorTok{-}\FloatTok{1.1}\NormalTok{,}\DataTypeTok{length.out=}\DecValTok{12}\NormalTok{)}\OperatorTok{+}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\KeywordTok{rnorm}\NormalTok{(}\DecValTok{11}\NormalTok{,}\DecValTok{0}\NormalTok{,}\FloatTok{0.08}\NormalTok{)))}
\NormalTok{pred1 <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit1, new_data)}
\KeywordTok{plot_predict}\NormalTok{(pred1, }\DataTypeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\KeywordTok{length}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)}\OperatorTok{+}\DecValTok{1}\NormalTok{,}\DecValTok{12}\NormalTok{),}\DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\KeywordTok{unique}\NormalTok{(}\KeywordTok{year}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)),}\DecValTok{2017}\NormalTok{))}
\end{Highlighting}
...
\KeywordTok{library}\NormalTok{(walker)}
\KeywordTok{set.seed}\NormalTok{(}\DecValTok{666}\NormalTok{)}
\NormalTok{fit2 <-}\StringTok{ }\NormalTok{dados }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{Vendas=}\NormalTok{Vendas}\OperatorTok{-}\NormalTok{mAntes[}\DecValTok{1}\NormalTok{],Resistência=Resistência-mAntes[}\DecValTok{2}\NormalTok{]) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{walker}\NormalTok{(}\DataTypeTok{data=}\NormalTok{., }\DataTypeTok{formula =}\NormalTok{ Resistência }\OperatorTok{~}\StringTok{ }\DecValTok{-1}\OperatorTok{+}\KeywordTok{rw2}\NormalTok{(}\OperatorTok{~}\StringTok{ }\DecValTok{-1}\OperatorTok{+}\NormalTok{Vendas, }\DataTypeTok{beta=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{),}
        \DataTypeTok{sigma=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{),}\DataTypeTok{nu=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{)),}\DataTypeTok{sigma_y_prior=}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{100}\NormalTok{), }\DataTypeTok{chain=}\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{multiplot}\NormalTok{(}
  \KeywordTok{mcmc_areas}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(fit2}\OperatorTok{$}\NormalTok{stanfit), }\DataTypeTok{regex_pars =} \KeywordTok{c}\NormalTok{(}\StringTok{"sigma_rw2"}\NormalTok{), }\DataTypeTok{prob=}\FloatTok{0.9}\NormalTok{),}
  \KeywordTok{mcmc_areas}\NormalTok{(}\KeywordTok{as.matrix}\NormalTok{(fit2}\OperatorTok{$}\NormalTok{stanfit), }\DataTypeTok{regex_pars =} \KeywordTok{c}\NormalTok{(}\StringTok{"sigma_y"}\NormalTok{), }\DataTypeTok{prob=}\FloatTok{0.9}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot_coefs}\NormalTok{(fit2, }\DataTypeTok{scales =} \StringTok{"free"}\NormalTok{, }\DataTypeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\KeywordTok{length}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)}\OperatorTok{+}\DecValTok{1}\NormalTok{,}\DecValTok{12}\NormalTok{),}\DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\KeywordTok{unique}\NormalTok{(}\KeywordTok{year}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)),}\DecValTok{2017}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{pp_check}\NormalTok{(fit2, }\DataTypeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{theme_bw}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\KeywordTok{length}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)}\OperatorTok{+}\DecValTok{1}\NormalTok{,}\DecValTok{12}\NormalTok{),}\DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\KeywordTok{unique}\NormalTok{(}\KeywordTok{year}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)),}\DecValTok{2017}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{new_data <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Vendas=}\KeywordTok{seq}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Vendas[}\DecValTok{108}\NormalTok{]}\OperatorTok{-}\NormalTok{mAntes[}\DecValTok{1}\NormalTok{],}\OperatorTok{-}\FloatTok{0.4}\NormalTok{,}\DataTypeTok{length.out=}\DecValTok{12}\NormalTok{)}\OperatorTok{+}\KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{,}\KeywordTok{rnorm}\NormalTok{(}\DecValTok{11}\NormalTok{,}\DecValTok{0}\NormalTok{,}\FloatTok{0.08}\NormalTok{)))}
\NormalTok{pred2 <-}\StringTok{ }\KeywordTok{predict}\NormalTok{(fit2, new_data)}
\KeywordTok{plot_predict}\NormalTok{(pred2, }\DataTypeTok{alpha=}\FloatTok{0.8}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks=}\KeywordTok{seq}\NormalTok{(}\DecValTok{1}\NormalTok{,}\KeywordTok{length}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)}\OperatorTok{+}\DecValTok{1}\NormalTok{,}\DecValTok{12}\NormalTok{),}\DataTypeTok{labels=}\KeywordTok{c}\NormalTok{(}\KeywordTok{unique}\NormalTok{(}\KeywordTok{year}\NormalTok{(dados}\OperatorTok{$}\NormalTok{Período)),}\DecValTok{2017}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
